...
export class InventoryDB {
  ...
  async createInventoryItem(data) {
    try {
      ...
      const item = {
        ...
        uploadSchema: data.uploadSchema || null, // NEW: Upload requirements
  ...
  async updateAdDetails(state, adType, updateData) {
    try {
      ...
      if (updateData.uploadSchema !== undefined) {
        updateExpressions.push("uploadSchema = :uploadSchema")
        expressionAttributeValues[":uploadSchema"] = updateData.uploadSchema
      }
